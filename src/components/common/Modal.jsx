      ...
      >
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <div style={{ width: 4, height: 24, background: 'linear-gradient(180deg, #e74c3c, #c0392b)', borderRadius: 2, flexShrink: 0 }} />
            <span style={{ fontSize: 16, fontWeight: 800, color: '#1a202c', letterSpacing: '-0.2px' }}>{title}</span>
          </div>
          <button
            onClick={onClose}
            style={{
        ...
        {footer && (
          <div style={{
            padding: '14px 24px 20px', borderTop: '1px solid #e8ecf0',
