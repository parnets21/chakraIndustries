...
const PAGE_META = {
  dashboard:  {
    ...
    kpis: [
      ...
      { label: 'Active SKU',       value: '—', icon: <MdCheckBox size={18} />,       color: '#16a34a', color2: '#22c55e', glow: 'rgba(22,163,74,0.25)' },
    ],
  },
  stock: {
    title: 'Stock Table',
    ...
    actionLabel: '+ Add Stock',
    kpis: [
      { label: 'Total SKU',     value: '—', icon: <MdInventory2 size={18} />,     color: '#c0392b', color2: '#e74c3c', glow: 'rgba(192,57,43,0.25)' },
